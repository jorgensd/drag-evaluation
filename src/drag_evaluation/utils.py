...
import numpy as np
from fenics import (Constant, Expression, FiniteElement, Function,
                    FunctionSpace, HDF5File, Measure, Mesh, MeshFunction,
                    MixedElement, SubDomain, VectorElement, assemble, div, dot,
                    dx, grad, inner, near)
...
__all__ = [
    ...
    "mark_boundaries_expduct",
    "get_computed_nus_cylinder",
    "get_closest_computed_Rs_expduct",
]
...
def get_closest_computed_Rs_expduct(loc, R, params, larger=False):
    ...
    for filename in os.listdir(loc):
        ...
        disc_desc = "_alpha_{alpha:n}_k_{k:n}_DG_{DG:n}_N_{N:n}".format(**params)
